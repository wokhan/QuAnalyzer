...
namespace QuAnalyzer.UI.Controls
{
    ...
    public class DecoratedTabItem : TabItem
    {
        ...
        public static DependencyProperty ImageProperty = DependencyProperty.Register(nameof(Image), typeof(Geometry), typeof(DecoratedTabItem), new PropertyMetadata(null));
