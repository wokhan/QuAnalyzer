...
{
    public static void Run(TestCasesCollection testsCollection, int occurence, int burstOccurences, int threads, IProgress<TestResults>? progress = null)
    {
    ...
    private static void RunForOne(TestCasesCollection testsCollection, int occurence, IProgress<TestResults>? callback, int x)
    {
        ...
        testsCollection.TestCases
               ...
               .ForAll(testWithResults =>
               {
                   ...
                   testWithResults.test.Status = TestCaseStatus.RUNNING;
                   ...
                   testWithResults.test.Status = TestCaseStatus.DONE;
