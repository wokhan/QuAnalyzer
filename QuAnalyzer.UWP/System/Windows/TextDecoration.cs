namespace System.Windows
{
    ...
    public class TextDecoration : Proxy<global::Windows.UI.Xaml.TextDecoration>
    {
        ...
        public System.Double PenOffset
        {
            get => __ProxyValue.PenOffset;
            set => __ProxyValue.PenOffset = value;
        }

        public System.Windows.TextDecorationUnit PenOffsetUnit
        {
            get => __ProxyValue.PenOffsetUnit;
            set => __ProxyValue.PenOffsetUnit = value;
        }

        public System.Windows.TextDecorationUnit PenThicknessUnit
        {
            get => __ProxyValue.PenThicknessUnit;
            set => __ProxyValue.PenThicknessUnit = value;
        }

        public System.Windows.TextDecorationLocation Location
        {
        ...
        public TextDecoration(): base()
        {
        }

        public TextDecoration(System.Windows.TextDecorationLocation @location, System.Windows.Media.Pen @pen, System.Double @penOffset, System.Windows.TextDecorationUnit @penOffsetUnit, System.Windows.TextDecorationUnit @penThicknessUnit): base(@location, @pen, @penOffset, @penOffsetUnit, @penThicknessUnit)
        {
        }

        public System.Windows.TextDecoration Clone() => __ProxyValue.Clone();
        public System.Windows.TextDecoration CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
