namespace System.Windows.Media.Imaging
{
    ...
    public class ColorConvertedBitmap : Proxy<global::Windows.UI.Xaml.Media.Imaging.ColorConvertedBitmap>
    {
        ...
        public System.Windows.Media.ColorContext SourceColorContext
        {
            get => __ProxyValue.SourceColorContext;
            set => __ProxyValue.SourceColorContext = value;
        }

        public System.Windows.Media.ColorContext DestinationColorContext
        {
            get => __ProxyValue.DestinationColorContext;
            set => __ProxyValue.DestinationColorContext = value;
        }
        ...
        public ColorConvertedBitmap(): base()
        {
        }

        public ColorConvertedBitmap(System.Windows.Media.Imaging.BitmapSource @source, System.Windows.Media.ColorContext @sourceColorContext, System.Windows.Media.ColorContext @destinationColorContext, System.Windows.Media.PixelFormat @format): base(@source, @sourceColorContext, @destinationColorContext, @format)
        {
        }

        public void BeginInit() => __ProxyValue.BeginInit();
        public void EndInit() => __ProxyValue.EndInit();
        public System.Windows.Media.Imaging.ColorConvertedBitmap Clone() => __ProxyValue.Clone();
        public System.Windows.Media.Imaging.ColorConvertedBitmap CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
