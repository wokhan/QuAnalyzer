namespace System.Windows.Media.Effects
{
    ...
    public class BitmapEffectCollection : Proxy<global::Windows.UI.Xaml.Media.Effects.BitmapEffectCollection>
    {
        public System.Windows.Media.Effects.BitmapEffect Item
        {
        ...
        public BitmapEffectCollection(): base()
        {
        }

        public BitmapEffectCollection(System.Int32 @capacity): base(@capacity)
        {
        }

        public BitmapEffectCollection(System.Collections.Generic.IEnumerable<System.Windows.Media.Effects.BitmapEffect> @collection): base(@collection)
        {
        }

        public System.Windows.Media.Effects.BitmapEffectCollection Clone() => __ProxyValue.Clone();
        public System.Windows.Media.Effects.BitmapEffectCollection CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
        public void Add(System.Windows.Media.Effects.BitmapEffect value) => __ProxyValue.Add(@value);
        public void Clear() => __ProxyValue.Clear();
        public System.Boolean Contains(System.Windows.Media.Effects.BitmapEffect value) => __ProxyValue.Contains(@value);
        public System.Int32 IndexOf(System.Windows.Media.Effects.BitmapEffect value) => __ProxyValue.IndexOf(@value);
        public void Insert(System.Int32 index, System.Windows.Media.Effects.BitmapEffect value) => __ProxyValue.Insert(@index, @value);
        public System.Boolean Remove(System.Windows.Media.Effects.BitmapEffect value) => __ProxyValue.Remove(@value);
        public void RemoveAt(System.Int32 index) => __ProxyValue.RemoveAt(@index);
        public void CopyTo(System.Windows.Media.Effects.BitmapEffect[] array, System.Int32 index) => __ProxyValue.CopyTo(@array, @index);
        public System.Windows.Media.Effects.Enumerator GetEnumerator() => __ProxyValue.GetEnumerator();
