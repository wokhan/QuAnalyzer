namespace System.Windows.Media.Effects
{
    ...
    public class BevelBitmapEffect : Proxy<global::Windows.UI.Xaml.Media.Effects.BevelBitmapEffect>
    {
        public System.Double BevelWidth
        {
            get => __ProxyValue.BevelWidth;
            set => __ProxyValue.BevelWidth = value;
        }

        public System.Double Relief
        {
            get => __ProxyValue.Relief;
            set => __ProxyValue.Relief = value;
        }

        public System.Double LightAngle
        {
            get => __ProxyValue.LightAngle;
            set => __ProxyValue.LightAngle = value;
        }

        public System.Double Smoothness
        {
            get => __ProxyValue.Smoothness;
            set => __ProxyValue.Smoothness = value;
        }

        public System.Windows.Media.Effects.EdgeProfile EdgeProfile
        {
            get => __ProxyValue.EdgeProfile;
            set => __ProxyValue.EdgeProfile = value;
        }
        ...
        public BevelBitmapEffect(): base()
        {
        }

        public System.Windows.Media.Effects.BevelBitmapEffect Clone() => __ProxyValue.Clone();
        public System.Windows.Media.Effects.BevelBitmapEffect CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
        public System.Windows.Media.Imaging.BitmapSource GetOutput(System.Windows.Media.Effects.BitmapEffectInput input) => __ProxyValue.GetOutput(@input);
