namespace System.Windows.Media.Effects
{
    ...
    public class BitmapEffectInput : Proxy<global::Windows.UI.Xaml.Media.Effects.BitmapEffectInput>
    {
        public static System.Windows.Media.Imaging.BitmapSource ContextInputSource
        {
            get => __ProxyValue.ContextInputSource;
        }

        public System.Windows.Media.Imaging.BitmapSource Input
        {
            get => __ProxyValue.Input;
            set => __ProxyValue.Input = value;
        }

        public System.Windows.Media.BrushMappingMode AreaToApplyEffectUnits
        {
            get => __ProxyValue.AreaToApplyEffectUnits;
            set => __ProxyValue.AreaToApplyEffectUnits = value;
        }

        public System.Windows.Rect AreaToApplyEffect
        {
            get => __ProxyValue.AreaToApplyEffect;
            set => __ProxyValue.AreaToApplyEffect = value;
        }
        ...
        public BitmapEffectInput(): base()
        {
        }

        public BitmapEffectInput(System.Windows.Media.Imaging.BitmapSource @input): base(@input)
        {
        }

        public System.Boolean ShouldSerializeInput() => __ProxyValue.ShouldSerializeInput();
        public System.Windows.Media.Effects.BitmapEffectInput Clone() => __ProxyValue.Clone();
        public System.Windows.Media.Effects.BitmapEffectInput CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
