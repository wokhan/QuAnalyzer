namespace System.Windows.Media
{
    ...
    public class GeometryCollection : Proxy<global::Windows.UI.Xaml.Media.GeometryCollection>
    {
        public System.Windows.Media.Geometry Item
        {
        ...
        public GeometryCollection(System.Int32 @capacity): base(@capacity)
        {
        }

        public GeometryCollection(System.Collections.Generic.IEnumerable<System.Windows.Media.Geometry> @collection): base(@collection)
        {
        }

        public System.Windows.Media.GeometryCollection Clone() => __ProxyValue.Clone();
        public System.Windows.Media.GeometryCollection CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
        public void Add(System.Windows.Media.Geometry value) => __ProxyValue.Add(@value);
        public void Clear() => __ProxyValue.Clear();
        public System.Boolean Contains(System.Windows.Media.Geometry value) => __ProxyValue.Contains(@value);
        public System.Int32 IndexOf(System.Windows.Media.Geometry value) => __ProxyValue.IndexOf(@value);
        public void Insert(System.Int32 index, System.Windows.Media.Geometry value) => __ProxyValue.Insert(@index, @value);
        public System.Boolean Remove(System.Windows.Media.Geometry value) => __ProxyValue.Remove(@value);
        public void RemoveAt(System.Int32 index) => __ProxyValue.RemoveAt(@index);
        public void CopyTo(System.Windows.Media.Geometry[] array, System.Int32 index) => __ProxyValue.CopyTo(@array, @index);
