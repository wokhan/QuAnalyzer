namespace System.Windows.Media
{
    ...
    public class ArcSegment : Proxy<global::Windows.UI.Xaml.Media.ArcSegment>
    {
        ...
        {
            get => __ProxyValue.RotationAngle;
            set => __ProxyValue.RotationAngle = value;
        }

        public System.Boolean IsLargeArc
        {
            get => __ProxyValue.IsLargeArc;
            set => __ProxyValue.IsLargeArc = value;
        }

        public System.Windows.Media.SweepDirection SweepDirection
        {
            get => __ProxyValue.SweepDirection;
            set => __ProxyValue.SweepDirection = value;
        }
        ...
        public ArcSegment(): base()
        {
        }

        public ArcSegment(System.Windows.Point @point, System.Windows.Size @size, System.Double @rotationAngle, System.Boolean @isLargeArc, System.Windows.Media.SweepDirection @sweepDirection, System.Boolean @isStroked): base(@point, @size, @rotationAngle, @isLargeArc, @sweepDirection, @isStroked)
        {
        }

        public System.Windows.Media.ArcSegment Clone() => __ProxyValue.Clone();
        public System.Windows.Media.ArcSegment CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
