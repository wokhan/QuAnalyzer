namespace System.Windows.Media
{
    ...
    public class GradientStopCollection : Proxy<global::Windows.UI.Xaml.Media.GradientStopCollection>
    {
        public System.Windows.Media.GradientStop Item
        {
        ...
        public GradientStopCollection(): base()
        {
        }

        public GradientStopCollection(System.Int32 @capacity): base(@capacity)
        {
        }

        public GradientStopCollection(System.Collections.Generic.IEnumerable<System.Windows.Media.GradientStop> @collection): base(@collection)
        {
        }

        public System.Windows.Media.GradientStopCollection Clone() => __ProxyValue.Clone();
        public System.Windows.Media.GradientStopCollection CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
        public void Add(System.Windows.Media.GradientStop value) => __ProxyValue.Add(@value);
        public void Clear() => __ProxyValue.Clear();
        public System.Boolean Contains(System.Windows.Media.GradientStop value) => __ProxyValue.Contains(@value);
        public System.Int32 IndexOf(System.Windows.Media.GradientStop value) => __ProxyValue.IndexOf(@value);
        public void Insert(System.Int32 index, System.Windows.Media.GradientStop value) => __ProxyValue.Insert(@index, @value);
        public System.Boolean Remove(System.Windows.Media.GradientStop value) => __ProxyValue.Remove(@value);
        public void RemoveAt(System.Int32 index) => __ProxyValue.RemoveAt(@index);
        public void CopyTo(System.Windows.Media.GradientStop[] array, System.Int32 index) => __ProxyValue.CopyTo(@array, @index);
        ...
        public static System.Windows.Media.GradientStopCollection Parse(System.String source) => Windows.UI.Xaml.Media.GradientStopCollection.Parse(@source);
