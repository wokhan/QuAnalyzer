namespace System.Windows.Media
{
    ...
    public class TransformCollection : Proxy<global::Windows.UI.Xaml.Media.TransformCollection>
    {
        public System.Windows.Media.Transform Item
        {
        ...
        public TransformCollection(): base()
        {
        }

        public TransformCollection(System.Int32 @capacity): base(@capacity)
        {
        }

        public TransformCollection(System.Collections.Generic.IEnumerable<System.Windows.Media.Transform> @collection): base(@collection)
        {
        }

        public System.Windows.Media.TransformCollection Clone() => __ProxyValue.Clone();
        public System.Windows.Media.TransformCollection CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
        public void Add(System.Windows.Media.Transform value) => __ProxyValue.Add(@value);
        public void Clear() => __ProxyValue.Clear();
        public System.Boolean Contains(System.Windows.Media.Transform value) => __ProxyValue.Contains(@value);
        public System.Int32 IndexOf(System.Windows.Media.Transform value) => __ProxyValue.IndexOf(@value);
        public void Insert(System.Int32 index, System.Windows.Media.Transform value) => __ProxyValue.Insert(@index, @value);
        public System.Boolean Remove(System.Windows.Media.Transform value) => __ProxyValue.Remove(@value);
        public void RemoveAt(System.Int32 index) => __ProxyValue.RemoveAt(@index);
        public void CopyTo(System.Windows.Media.Transform[] array, System.Int32 index) => __ProxyValue.CopyTo(@array, @index);
