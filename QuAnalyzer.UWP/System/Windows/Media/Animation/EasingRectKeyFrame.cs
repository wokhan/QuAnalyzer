namespace System.Windows.Media.Animation
{
    ...
    public class EasingRectKeyFrame : Proxy<global::Windows.UI.Xaml.Media.Animation.EasingRectKeyFrame>
    {
        ...
        public System.Windows.Rect Value
        {
        ...
        public EasingRectKeyFrame(): base()
        {
        }

        public EasingRectKeyFrame(System.Windows.Rect @value): base(@value)
        {
        }

        public EasingRectKeyFrame(System.Windows.Rect @value, System.Windows.Media.Animation.KeyTime @keyTime): base(@value, @keyTime)
        {
        }

        public EasingRectKeyFrame(System.Windows.Rect @value, System.Windows.Media.Animation.KeyTime @keyTime, System.Windows.Media.Animation.IEasingFunction @easingFunction): base(@value, @keyTime, @easingFunction)
        {
        }

        public System.Windows.Rect InterpolateValue(System.Windows.Rect baseValue, System.Double keyFrameProgress) => __ProxyValue.InterpolateValue(@baseValue, @keyFrameProgress);
