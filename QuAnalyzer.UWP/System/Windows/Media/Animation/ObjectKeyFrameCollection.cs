namespace System.Windows.Media.Animation
{
    ...
    public class ObjectKeyFrameCollection : Proxy<global::Windows.UI.Xaml.Media.Animation.ObjectKeyFrameCollection>
    {
        ...
        public System.Windows.Media.Animation.ObjectKeyFrame Item
        {
        ...
        public ObjectKeyFrameCollection(): base()
        {
        }

        public System.Windows.Media.Animation.ObjectKeyFrameCollection Clone() => __ProxyValue.Clone();
        public System.Collections.IEnumerator GetEnumerator() => __ProxyValue.GetEnumerator();
        public void CopyTo(System.Windows.Media.Animation.ObjectKeyFrame[] array, System.Int32 index) => __ProxyValue.CopyTo(@array, @index);
        public System.Int32 Add(System.Windows.Media.Animation.ObjectKeyFrame keyFrame) => __ProxyValue.Add(@keyFrame);
        public void Clear() => __ProxyValue.Clear();
        public System.Boolean Contains(System.Windows.Media.Animation.ObjectKeyFrame keyFrame) => __ProxyValue.Contains(@keyFrame);
        public System.Int32 IndexOf(System.Windows.Media.Animation.ObjectKeyFrame keyFrame) => __ProxyValue.IndexOf(@keyFrame);
        public void Insert(System.Int32 index, System.Windows.Media.Animation.ObjectKeyFrame keyFrame) => __ProxyValue.Insert(@index, @keyFrame);
        public void Remove(System.Windows.Media.Animation.ObjectKeyFrame keyFrame) => __ProxyValue.Remove(@keyFrame);
