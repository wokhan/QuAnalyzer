namespace System.Windows.Media.Animation
{
    ...
    public class EasingDecimalKeyFrame : Proxy<global::Windows.UI.Xaml.Media.Animation.EasingDecimalKeyFrame>
    {
        ...
        public EasingDecimalKeyFrame(): base()
        {
        }

        public EasingDecimalKeyFrame(System.Decimal @value): base(@value)
        {
        }

        public EasingDecimalKeyFrame(System.Decimal @value, System.Windows.Media.Animation.KeyTime @keyTime): base(@value, @keyTime)
        {
        }

        public EasingDecimalKeyFrame(System.Decimal @value, System.Windows.Media.Animation.KeyTime @keyTime, System.Windows.Media.Animation.IEasingFunction @easingFunction): base(@value, @keyTime, @easingFunction)
        {
        }

        public System.Decimal InterpolateValue(System.Decimal baseValue, System.Double keyFrameProgress) => __ProxyValue.InterpolateValue(@baseValue, @keyFrameProgress);
