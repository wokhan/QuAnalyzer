namespace System.Windows.Media.Animation
{
    ...
    public class DiscreteBooleanKeyFrame : Proxy<global::Windows.UI.Xaml.Media.Animation.DiscreteBooleanKeyFrame>
    {
        ...
        public DiscreteBooleanKeyFrame(): base()
        {
        }

        public DiscreteBooleanKeyFrame(System.Boolean @value): base(@value)
        {
        }

        public DiscreteBooleanKeyFrame(System.Boolean @value, System.Windows.Media.Animation.KeyTime @keyTime): base(@value, @keyTime)
        {
        }

        public System.Boolean InterpolateValue(System.Boolean baseValue, System.Double keyFrameProgress) => __ProxyValue.InterpolateValue(@baseValue, @keyFrameProgress);
