namespace System.Windows.Media.Animation
{
    ...
    public class Rotation3DAnimation : Proxy<global::Windows.UI.Xaml.Media.Animation.Rotation3DAnimation>
    {
        public System.Windows.Media.Media3D.Rotation3D From
        {
            get => __ProxyValue.From;
            set => __ProxyValue.From = value;
        }

        public System.Windows.Media.Media3D.Rotation3D To
        {
            get => __ProxyValue.To;
            set => __ProxyValue.To = value;
        }

        public System.Windows.Media.Media3D.Rotation3D By
        {
            get => __ProxyValue.By;
        ...
        public Rotation3DAnimation(): base()
        {
        }

        public Rotation3DAnimation(System.Windows.Media.Media3D.Rotation3D @toValue, System.Windows.Duration @duration): base(@toValue, @duration)
        {
        }

        public Rotation3DAnimation(System.Windows.Media.Media3D.Rotation3D @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@toValue, @duration, @fillBehavior)
        {
        }

        public Rotation3DAnimation(System.Windows.Media.Media3D.Rotation3D @fromValue, System.Windows.Media.Media3D.Rotation3D @toValue, System.Windows.Duration @duration): base(@fromValue, @toValue, @duration)
        {
        }

        public Rotation3DAnimation(System.Windows.Media.Media3D.Rotation3D @fromValue, System.Windows.Media.Media3D.Rotation3D @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@fromValue, @toValue, @duration, @fillBehavior)
        {
        }

        public System.Windows.Media.Animation.Rotation3DAnimation Clone() => __ProxyValue.Clone();
