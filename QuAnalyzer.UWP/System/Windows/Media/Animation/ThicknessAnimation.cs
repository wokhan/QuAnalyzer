namespace System.Windows.Media.Animation
{
    ...
    public class ThicknessAnimation : Proxy<global::Windows.UI.Xaml.Media.Animation.ThicknessAnimation>
    {
        public System.Nullable<System.Windows.Thickness> From
        {
            get => __ProxyValue.From;
            set => __ProxyValue.From = value;
        }

        public System.Nullable<System.Windows.Thickness> To
        {
            get => __ProxyValue.To;
            set => __ProxyValue.To = value;
        }

        public System.Nullable<System.Windows.Thickness> By
        {
            get => __ProxyValue.By;
        ...
        public ThicknessAnimation(): base()
        {
        }

        public ThicknessAnimation(System.Windows.Thickness @toValue, System.Windows.Duration @duration): base(@toValue, @duration)
        {
        }

        public ThicknessAnimation(System.Windows.Thickness @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@toValue, @duration, @fillBehavior)
        {
        }

        public ThicknessAnimation(System.Windows.Thickness @fromValue, System.Windows.Thickness @toValue, System.Windows.Duration @duration): base(@fromValue, @toValue, @duration)
        {
        }

        public ThicknessAnimation(System.Windows.Thickness @fromValue, System.Windows.Thickness @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@fromValue, @toValue, @duration, @fillBehavior)
        {
        }

        public System.Windows.Media.Animation.ThicknessAnimation Clone() => __ProxyValue.Clone();
        ...
        public System.Windows.Thickness GetCurrentValue(System.Windows.Thickness defaultOriginValue, System.Windows.Thickness defaultDestinationValue, System.Windows.Media.Animation.AnimationClock animationClock) => __ProxyValue.GetCurrentValue(@defaultOriginValue, @defaultDestinationValue, @animationClock);
