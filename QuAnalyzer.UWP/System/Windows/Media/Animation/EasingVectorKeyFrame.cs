namespace System.Windows.Media.Animation
{
    ...
    public class EasingVectorKeyFrame : Proxy<global::Windows.UI.Xaml.Media.Animation.EasingVectorKeyFrame>
    {
        ...
        public EasingVectorKeyFrame(): base()
        {
        }

        public EasingVectorKeyFrame(System.Windows.Vector @value): base(@value)
        {
        }

        public EasingVectorKeyFrame(System.Windows.Vector @value, System.Windows.Media.Animation.KeyTime @keyTime): base(@value, @keyTime)
        {
        }

        public EasingVectorKeyFrame(System.Windows.Vector @value, System.Windows.Media.Animation.KeyTime @keyTime, System.Windows.Media.Animation.IEasingFunction @easingFunction): base(@value, @keyTime, @easingFunction)
        {
        }

        public System.Windows.Vector InterpolateValue(System.Windows.Vector baseValue, System.Double keyFrameProgress) => __ProxyValue.InterpolateValue(@baseValue, @keyFrameProgress);
