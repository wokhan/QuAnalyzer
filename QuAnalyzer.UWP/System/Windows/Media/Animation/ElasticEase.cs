namespace System.Windows.Media.Animation
{
    ...
    public class ElasticEase : Proxy<global::Windows.UI.Xaml.Media.Animation.ElasticEase>
    {
        public System.Int32 Oscillations
        {
            get => __ProxyValue.Oscillations;
            set => __ProxyValue.Oscillations = value;
        }

        public System.Double Springiness
        {
            get => __ProxyValue.Springiness;
            set => __ProxyValue.Springiness = value;
        }

        public System.Windows.Media.Animation.EasingMode EasingMode
        {
            get => __ProxyValue.EasingMode;
            set => __ProxyValue.EasingMode = value;
        }
        ...
        public ElasticEase(): base()
        {
        }

        public System.Double Ease(System.Double normalizedTime) => __ProxyValue.Ease(@normalizedTime);
