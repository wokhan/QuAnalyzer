namespace System.Windows.Media.Animation
{
    ...
    public class VectorAnimation : Proxy<global::Windows.UI.Xaml.Media.Animation.VectorAnimation>
    {
        public System.Nullable<System.Windows.Vector> From
        {
            get => __ProxyValue.From;
            set => __ProxyValue.From = value;
        }

        public System.Nullable<System.Windows.Vector> To
        {
            get => __ProxyValue.To;
            set => __ProxyValue.To = value;
        }

        public System.Nullable<System.Windows.Vector> By
        {
            get => __ProxyValue.By;
        ...
        public VectorAnimation(): base()
        {
        }

        public VectorAnimation(System.Windows.Vector @toValue, System.Windows.Duration @duration): base(@toValue, @duration)
        {
        }

        public VectorAnimation(System.Windows.Vector @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@toValue, @duration, @fillBehavior)
        {
        }

        public VectorAnimation(System.Windows.Vector @fromValue, System.Windows.Vector @toValue, System.Windows.Duration @duration): base(@fromValue, @toValue, @duration)
        {
        }

        public VectorAnimation(System.Windows.Vector @fromValue, System.Windows.Vector @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@fromValue, @toValue, @duration, @fillBehavior)
        {
        }

        public System.Windows.Media.Animation.VectorAnimation Clone() => __ProxyValue.Clone();
        ...
        public System.Windows.Vector GetCurrentValue(System.Windows.Vector defaultOriginValue, System.Windows.Vector defaultDestinationValue, System.Windows.Media.Animation.AnimationClock animationClock) => __ProxyValue.GetCurrentValue(@defaultOriginValue, @defaultDestinationValue, @animationClock);
