namespace System.Windows.Media.Animation
{
    ...
    public class ColorAnimation : Proxy<global::Windows.UI.Xaml.Media.Animation.ColorAnimation>
    {
        public System.Nullable<System.Windows.Media.Color> From
        {
            get => __ProxyValue.From;
            set => __ProxyValue.From = value;
        }

        public System.Nullable<System.Windows.Media.Color> To
        {
            get => __ProxyValue.To;
            set => __ProxyValue.To = value;
        }

        public System.Nullable<System.Windows.Media.Color> By
        {
            get => __ProxyValue.By;
        ...
        public ColorAnimation(System.Windows.Media.Color @toValue, System.Windows.Duration @duration): base(@toValue, @duration)
        {
        }

        public ColorAnimation(System.Windows.Media.Color @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@toValue, @duration, @fillBehavior)
        {
        }

        public ColorAnimation(System.Windows.Media.Color @fromValue, System.Windows.Media.Color @toValue, System.Windows.Duration @duration): base(@fromValue, @toValue, @duration)
        {
        }

        public ColorAnimation(System.Windows.Media.Color @fromValue, System.Windows.Media.Color @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@fromValue, @toValue, @duration, @fillBehavior)
        {
        }

        public System.Windows.Media.Animation.ColorAnimation Clone() => __ProxyValue.Clone();
        ...
        public System.Windows.Media.Color GetCurrentValue(System.Windows.Media.Color defaultOriginValue, System.Windows.Media.Color defaultDestinationValue, System.Windows.Media.Animation.AnimationClock animationClock) => __ProxyValue.GetCurrentValue(@defaultOriginValue, @defaultDestinationValue, @animationClock);
