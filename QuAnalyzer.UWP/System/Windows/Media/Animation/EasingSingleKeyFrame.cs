namespace System.Windows.Media.Animation
{
    ...
    public class EasingSingleKeyFrame : Proxy<global::Windows.UI.Xaml.Media.Animation.EasingSingleKeyFrame>
    {
        ...
        public EasingSingleKeyFrame(): base()
        {
        }

        public EasingSingleKeyFrame(System.Single @value): base(@value)
        {
        }

        public EasingSingleKeyFrame(System.Single @value, System.Windows.Media.Animation.KeyTime @keyTime): base(@value, @keyTime)
        {
        }

        public EasingSingleKeyFrame(System.Single @value, System.Windows.Media.Animation.KeyTime @keyTime, System.Windows.Media.Animation.IEasingFunction @easingFunction): base(@value, @keyTime, @easingFunction)
        {
        }

        public System.Single InterpolateValue(System.Single baseValue, System.Double keyFrameProgress) => __ProxyValue.InterpolateValue(@baseValue, @keyFrameProgress);
