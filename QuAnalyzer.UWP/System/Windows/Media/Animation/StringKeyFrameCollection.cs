namespace System.Windows.Media.Animation
{
    ...
    public class StringKeyFrameCollection : Proxy<global::Windows.UI.Xaml.Media.Animation.StringKeyFrameCollection>
    {
        ...
        public System.Windows.Media.Animation.StringKeyFrame Item
        {
        ...
        public StringKeyFrameCollection(): base()
        {
        }

        public System.Windows.Media.Animation.StringKeyFrameCollection Clone() => __ProxyValue.Clone();
        public System.Collections.IEnumerator GetEnumerator() => __ProxyValue.GetEnumerator();
        public void CopyTo(System.Windows.Media.Animation.StringKeyFrame[] array, System.Int32 index) => __ProxyValue.CopyTo(@array, @index);
        public System.Int32 Add(System.Windows.Media.Animation.StringKeyFrame keyFrame) => __ProxyValue.Add(@keyFrame);
        public void Clear() => __ProxyValue.Clear();
        public System.Boolean Contains(System.Windows.Media.Animation.StringKeyFrame keyFrame) => __ProxyValue.Contains(@keyFrame);
        public System.Int32 IndexOf(System.Windows.Media.Animation.StringKeyFrame keyFrame) => __ProxyValue.IndexOf(@keyFrame);
        public void Insert(System.Int32 index, System.Windows.Media.Animation.StringKeyFrame keyFrame) => __ProxyValue.Insert(@index, @keyFrame);
        public void Remove(System.Windows.Media.Animation.StringKeyFrame keyFrame) => __ProxyValue.Remove(@keyFrame);
