namespace System.Windows.Media.Animation
{
    ...
    public class Point3DAnimation : Proxy<global::Windows.UI.Xaml.Media.Animation.Point3DAnimation>
    {
        public System.Nullable<System.Windows.Media.Media3D.Point3D> From
        {
            get => __ProxyValue.From;
            set => __ProxyValue.From = value;
        }

        public System.Nullable<System.Windows.Media.Media3D.Point3D> To
        {
            get => __ProxyValue.To;
            set => __ProxyValue.To = value;
        }

        public System.Nullable<System.Windows.Media.Media3D.Point3D> By
        {
            get => __ProxyValue.By;
        ...
        public Point3DAnimation(): base()
        {
        }

        public Point3DAnimation(System.Windows.Media.Media3D.Point3D @toValue, System.Windows.Duration @duration): base(@toValue, @duration)
        {
        }

        public Point3DAnimation(System.Windows.Media.Media3D.Point3D @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@toValue, @duration, @fillBehavior)
        {
        }

        public Point3DAnimation(System.Windows.Media.Media3D.Point3D @fromValue, System.Windows.Media.Media3D.Point3D @toValue, System.Windows.Duration @duration): base(@fromValue, @toValue, @duration)
        {
        }

        public Point3DAnimation(System.Windows.Media.Media3D.Point3D @fromValue, System.Windows.Media.Media3D.Point3D @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@fromValue, @toValue, @duration, @fillBehavior)
        {
        }

        public System.Windows.Media.Animation.Point3DAnimation Clone() => __ProxyValue.Clone();
        ...
        public System.Windows.Media.Media3D.Point3D GetCurrentValue(System.Windows.Media.Media3D.Point3D defaultOriginValue, System.Windows.Media.Media3D.Point3D defaultDestinationValue, System.Windows.Media.Animation.AnimationClock animationClock) => __ProxyValue.GetCurrentValue(@defaultOriginValue, @defaultDestinationValue, @animationClock);
