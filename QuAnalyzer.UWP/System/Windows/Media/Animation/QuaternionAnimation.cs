namespace System.Windows.Media.Animation
{
    ...
    public class QuaternionAnimation : Proxy<global::Windows.UI.Xaml.Media.Animation.QuaternionAnimation>
    {
        public System.Boolean UseShortestPath
        {
            get => __ProxyValue.UseShortestPath;
            set => __ProxyValue.UseShortestPath = value;
        }

        public System.Nullable<System.Windows.Media.Media3D.Quaternion> From
        {
            get => __ProxyValue.From;
            set => __ProxyValue.From = value;
        }

        public System.Nullable<System.Windows.Media.Media3D.Quaternion> To
        {
            get => __ProxyValue.To;
            set => __ProxyValue.To = value;
        }

        public System.Nullable<System.Windows.Media.Media3D.Quaternion> By
        {
            get => __ProxyValue.By;
        ...
        public QuaternionAnimation(): base()
        {
        }

        public QuaternionAnimation(System.Windows.Media.Media3D.Quaternion @toValue, System.Windows.Duration @duration): base(@toValue, @duration)
        {
        }

        public QuaternionAnimation(System.Windows.Media.Media3D.Quaternion @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@toValue, @duration, @fillBehavior)
        {
        }

        public QuaternionAnimation(System.Windows.Media.Media3D.Quaternion @fromValue, System.Windows.Media.Media3D.Quaternion @toValue, System.Windows.Duration @duration): base(@fromValue, @toValue, @duration)
        {
        }

        public QuaternionAnimation(System.Windows.Media.Media3D.Quaternion @fromValue, System.Windows.Media.Media3D.Quaternion @toValue, System.Windows.Duration @duration, System.Windows.Media.Animation.FillBehavior @fillBehavior): base(@fromValue, @toValue, @duration, @fillBehavior)
        {
        }

        public System.Windows.Media.Animation.QuaternionAnimation Clone() => __ProxyValue.Clone();
