namespace System.Windows.Media.Animation
{
    ...
    public class EasingByteKeyFrame : Proxy<global::Windows.UI.Xaml.Media.Animation.EasingByteKeyFrame>
    {
        ...
        public EasingByteKeyFrame(): base()
        {
        }

        public EasingByteKeyFrame(System.Byte @value): base(@value)
        {
        }

        public EasingByteKeyFrame(System.Byte @value, System.Windows.Media.Animation.KeyTime @keyTime): base(@value, @keyTime)
        {
        }

        public EasingByteKeyFrame(System.Byte @value, System.Windows.Media.Animation.KeyTime @keyTime, System.Windows.Media.Animation.IEasingFunction @easingFunction): base(@value, @keyTime, @easingFunction)
        {
        }

        public System.Byte InterpolateValue(System.Byte baseValue, System.Double keyFrameProgress) => __ProxyValue.InterpolateValue(@baseValue, @keyFrameProgress);
