namespace System.Windows.Media.Animation
{
    ...
    public class TimelineCollection : Proxy<global::Windows.UI.Xaml.Media.Animation.TimelineCollection>
    {
        public System.Windows.Media.Animation.Timeline Item
        {
        ...
        public TimelineCollection(): base()
        {
        }

        public TimelineCollection(System.Int32 @capacity): base(@capacity)
        {
        }

        public TimelineCollection(System.Collections.Generic.IEnumerable<System.Windows.Media.Animation.Timeline> @collection): base(@collection)
        {
        }

        public System.Windows.Media.Animation.TimelineCollection Clone() => __ProxyValue.Clone();
        public System.Windows.Media.Animation.TimelineCollection CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
        public void Add(System.Windows.Media.Animation.Timeline value) => __ProxyValue.Add(@value);
        public void Clear() => __ProxyValue.Clear();
        public System.Boolean Contains(System.Windows.Media.Animation.Timeline value) => __ProxyValue.Contains(@value);
        public System.Int32 IndexOf(System.Windows.Media.Animation.Timeline value) => __ProxyValue.IndexOf(@value);
        public void Insert(System.Int32 index, System.Windows.Media.Animation.Timeline value) => __ProxyValue.Insert(@index, @value);
        public System.Boolean Remove(System.Windows.Media.Animation.Timeline value) => __ProxyValue.Remove(@value);
        public void RemoveAt(System.Int32 index) => __ProxyValue.RemoveAt(@index);
        public void CopyTo(System.Windows.Media.Animation.Timeline[] array, System.Int32 index) => __ProxyValue.CopyTo(@array, @index);
        public System.Windows.Media.Animation.Enumerator GetEnumerator() => __ProxyValue.GetEnumerator();
