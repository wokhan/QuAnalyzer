namespace System.Windows.Media.Animation
{
    ...
    public class DiscreteCharKeyFrame : Proxy<global::Windows.UI.Xaml.Media.Animation.DiscreteCharKeyFrame>
    {
        ...
        public DiscreteCharKeyFrame(): base()
        {
        }

        public DiscreteCharKeyFrame(System.Char @value): base(@value)
        {
        }

        public DiscreteCharKeyFrame(System.Char @value, System.Windows.Media.Animation.KeyTime @keyTime): base(@value, @keyTime)
        {
        }

        public System.Char InterpolateValue(System.Char baseValue, System.Double keyFrameProgress) => __ProxyValue.InterpolateValue(@baseValue, @keyFrameProgress);
