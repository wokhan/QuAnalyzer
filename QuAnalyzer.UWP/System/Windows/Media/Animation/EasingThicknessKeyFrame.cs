namespace System.Windows.Media.Animation
{
    ...
    public class EasingThicknessKeyFrame : Proxy<global::Windows.UI.Xaml.Media.Animation.EasingThicknessKeyFrame>
    {
        ...
        public EasingThicknessKeyFrame(): base()
        {
        }

        public EasingThicknessKeyFrame(System.Windows.Thickness @value): base(@value)
        {
        }

        public EasingThicknessKeyFrame(System.Windows.Thickness @value, System.Windows.Media.Animation.KeyTime @keyTime): base(@value, @keyTime)
        {
        }

        public EasingThicknessKeyFrame(System.Windows.Thickness @value, System.Windows.Media.Animation.KeyTime @keyTime, System.Windows.Media.Animation.IEasingFunction @easingFunction): base(@value, @keyTime, @easingFunction)
        {
        }

        public System.Windows.Thickness InterpolateValue(System.Windows.Thickness baseValue, System.Double keyFrameProgress) => __ProxyValue.InterpolateValue(@baseValue, @keyFrameProgress);
