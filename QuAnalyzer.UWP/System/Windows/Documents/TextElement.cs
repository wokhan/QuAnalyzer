namespace System.Windows.Documents
{
    ...
    public class TextElement : Proxy<global::Windows.UI.Xaml.Documents.TextElement>
    {
        ...
        public static void SetFontFamily(System.Windows.DependencyObject element, System.Windows.Media.FontFamily value) => Windows.UI.Xaml.Documents.TextElement.SetFontFamily(@element, @value);
        public static System.Windows.Media.FontFamily GetFontFamily(System.Windows.DependencyObject element) => Windows.UI.Xaml.Documents.TextElement.GetFontFamily(@element);
        public static void SetFontStyle(System.Windows.DependencyObject element, System.Windows.FontStyle value) => Windows.UI.Xaml.Documents.TextElement.SetFontStyle(@element, @value);
        public static System.Windows.FontStyle GetFontStyle(System.Windows.DependencyObject element) => Windows.UI.Xaml.Documents.TextElement.GetFontStyle(@element);
        public static void SetFontWeight(System.Windows.DependencyObject element, System.Windows.FontWeight value) => Windows.UI.Xaml.Documents.TextElement.SetFontWeight(@element, @value);
        public static System.Windows.FontWeight GetFontWeight(System.Windows.DependencyObject element) => Windows.UI.Xaml.Documents.TextElement.GetFontWeight(@element);
        public static void SetFontStretch(System.Windows.DependencyObject element, System.Windows.FontStretch value) => Windows.UI.Xaml.Documents.TextElement.SetFontStretch(@element, @value);
        public static System.Windows.FontStretch GetFontStretch(System.Windows.DependencyObject element) => Windows.UI.Xaml.Documents.TextElement.GetFontStretch(@element);
        public static void SetFontSize(System.Windows.DependencyObject element, System.Double value) => Windows.UI.Xaml.Documents.TextElement.SetFontSize(@element, @value);
        public static System.Double GetFontSize(System.Windows.DependencyObject element) => Windows.UI.Xaml.Documents.TextElement.GetFontSize(@element);
        public static void SetForeground(System.Windows.DependencyObject element, System.Windows.Media.Brush value) => Windows.UI.Xaml.Documents.TextElement.SetForeground(@element, @value);
        public static System.Windows.Media.Brush GetForeground(System.Windows.DependencyObject element) => Windows.UI.Xaml.Documents.TextElement.GetForeground(@element);
