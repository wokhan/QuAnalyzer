namespace System.Windows.Input
{
    ...
    public class KeyBinding : Proxy<global::Windows.UI.Xaml.Input.KeyBinding>
    {
        ...
        public KeyBinding(System.Windows.Input.ICommand @command, System.Windows.Input.KeyGesture @gesture): base(@command, @gesture)
        {
        }

        public KeyBinding(System.Windows.Input.ICommand @command, System.Windows.Input.Key @key, System.Windows.Input.ModifierKeys @modifiers): base(@command, @key, @modifiers)
        {
        }
