namespace System.Windows.Controls
{
    ...
    public class GridSplitter : Proxy<global::Windows.UI.Xaml.Controls.GridSplitter>
    {
        public System.Windows.Controls.GridResizeDirection ResizeDirection
        {
            get => __ProxyValue.ResizeDirection;
            set => __ProxyValue.ResizeDirection = value;
        }

        public System.Windows.Controls.GridResizeBehavior ResizeBehavior
        {
            get => __ProxyValue.ResizeBehavior;
            set => __ProxyValue.ResizeBehavior = value;
        }

        public System.Boolean ShowsPreview
        {
            get => __ProxyValue.ShowsPreview;
            set => __ProxyValue.ShowsPreview = value;
        }

        public System.Windows.Style PreviewStyle
        {
            get => __ProxyValue.PreviewStyle;
            set => __ProxyValue.PreviewStyle = value;
        }

        public System.Double KeyboardIncrement
        {
            get => __ProxyValue.KeyboardIncrement;
            set => __ProxyValue.KeyboardIncrement = value;
        }

        public System.Double DragIncrement
        {
            get => __ProxyValue.DragIncrement;
            set => __ProxyValue.DragIncrement = value;
        }

        public System.Boolean IsDragging
        {
            get => __ProxyValue.IsDragging;
        }
        ...
        public GridSplitter(): base()
        {
        }

        public void add_DragStarted(System.Windows.Controls.Primitives.DragStartedEventHandler value) => __ProxyValue.add_DragStarted(@value);
        public void remove_DragStarted(System.Windows.Controls.Primitives.DragStartedEventHandler value) => __ProxyValue.remove_DragStarted(@value);
        public void add_DragDelta(System.Windows.Controls.Primitives.DragDeltaEventHandler value) => __ProxyValue.add_DragDelta(@value);
        public void remove_DragDelta(System.Windows.Controls.Primitives.DragDeltaEventHandler value) => __ProxyValue.remove_DragDelta(@value);
        public void add_DragCompleted(System.Windows.Controls.Primitives.DragCompletedEventHandler value) => __ProxyValue.add_DragCompleted(@value);
        public void remove_DragCompleted(System.Windows.Controls.Primitives.DragCompletedEventHandler value) => __ProxyValue.remove_DragCompleted(@value);
        public void CancelDrag() => __ProxyValue.CancelDrag();
