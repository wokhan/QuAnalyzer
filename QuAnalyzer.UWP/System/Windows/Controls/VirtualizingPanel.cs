namespace System.Windows.Controls
{
    ...
    public class VirtualizingPanel : Proxy<global::Windows.UI.Xaml.Controls.VirtualizingPanel>
    {
        public System.Boolean CanHierarchicallyScrollAndVirtualize
        {
            get => __ProxyValue.CanHierarchicallyScrollAndVirtualize;
        }
        ...
        public System.Boolean IsItemsHost
        {
            get => __ProxyValue.IsItemsHost;
            set => __ProxyValue.IsItemsHost = value;
        }

        public System.Windows.Controls.Orientation LogicalOrientationPublic
        {
            get => __ProxyValue.LogicalOrientationPublic;
        }

        public System.Boolean HasLogicalOrientationPublic
        {
            get => __ProxyValue.HasLogicalOrientationPublic;
        }
        ...
        public System.Double GetItemOffset(System.Windows.UIElement child) => __ProxyValue.GetItemOffset(@child);
        public static System.Boolean GetIsVirtualizing(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.VirtualizingPanel.GetIsVirtualizing(@element);
        public static void SetIsVirtualizing(System.Windows.DependencyObject element, System.Boolean value) => Windows.UI.Xaml.Controls.VirtualizingPanel.SetIsVirtualizing(@element, @value);
        public static System.Windows.Controls.VirtualizationMode GetVirtualizationMode(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.VirtualizingPanel.GetVirtualizationMode(@element);
        public static void SetVirtualizationMode(System.Windows.DependencyObject element, System.Windows.Controls.VirtualizationMode value) => Windows.UI.Xaml.Controls.VirtualizingPanel.SetVirtualizationMode(@element, @value);
        public static System.Boolean GetIsVirtualizingWhenGrouping(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.VirtualizingPanel.GetIsVirtualizingWhenGrouping(@element);
        public static void SetIsVirtualizingWhenGrouping(System.Windows.DependencyObject element, System.Boolean value) => Windows.UI.Xaml.Controls.VirtualizingPanel.SetIsVirtualizingWhenGrouping(@element, @value);
        public static System.Windows.Controls.ScrollUnit GetScrollUnit(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.VirtualizingPanel.GetScrollUnit(@element);
        public static void SetScrollUnit(System.Windows.DependencyObject element, System.Windows.Controls.ScrollUnit value) => Windows.UI.Xaml.Controls.VirtualizingPanel.SetScrollUnit(@element, @value);
        public static System.Windows.Controls.VirtualizationCacheLength GetCacheLength(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.VirtualizingPanel.GetCacheLength(@element);
        public static void SetCacheLength(System.Windows.DependencyObject element, System.Windows.Controls.VirtualizationCacheLength value) => Windows.UI.Xaml.Controls.VirtualizingPanel.SetCacheLength(@element, @value);
        public static System.Windows.Controls.VirtualizationCacheLengthUnit GetCacheLengthUnit(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.VirtualizingPanel.GetCacheLengthUnit(@element);
        public static void SetCacheLengthUnit(System.Windows.DependencyObject element, System.Windows.Controls.VirtualizationCacheLengthUnit value) => Windows.UI.Xaml.Controls.VirtualizingPanel.SetCacheLengthUnit(@element, @value);
        public static System.Boolean GetIsContainerVirtualizable(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.VirtualizingPanel.GetIsContainerVirtualizable(@element);
        public static void SetIsContainerVirtualizable(System.Windows.DependencyObject element, System.Boolean value) => Windows.UI.Xaml.Controls.VirtualizingPanel.SetIsContainerVirtualizable(@element, @value);
        public System.Boolean ShouldItemsChangeAffectLayout(System.Boolean areItemChangesLocal, System.Windows.Controls.Primitives.ItemsChangedEventArgs args) => __ProxyValue.ShouldItemsChangeAffectLayout(@areItemChangesLocal, @args);
        public void BringIndexIntoViewPublic(System.Int32 index) => __ProxyValue.BringIndexIntoViewPublic(@index);
        public System.Boolean ShouldSerializeChildren() => __ProxyValue.ShouldSerializeChildren();
