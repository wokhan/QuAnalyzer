namespace System.Windows.Controls.Primitives
{
    ...
    public class Selector : Proxy<global::Windows.UI.Xaml.Controls.Primitives.Selector>
    {
        ...
        public static void AddSelectedHandler(System.Windows.DependencyObject element, System.Windows.RoutedEventHandler handler) => Windows.UI.Xaml.Controls.Primitives.Selector.AddSelectedHandler(@element, @handler);
        public static void RemoveSelectedHandler(System.Windows.DependencyObject element, System.Windows.RoutedEventHandler handler) => Windows.UI.Xaml.Controls.Primitives.Selector.RemoveSelectedHandler(@element, @handler);
        public static void AddUnselectedHandler(System.Windows.DependencyObject element, System.Windows.RoutedEventHandler handler) => Windows.UI.Xaml.Controls.Primitives.Selector.AddUnselectedHandler(@element, @handler);
        public static void RemoveUnselectedHandler(System.Windows.DependencyObject element, System.Windows.RoutedEventHandler handler) => Windows.UI.Xaml.Controls.Primitives.Selector.RemoveUnselectedHandler(@element, @handler);
        public static System.Boolean GetIsSelectionActive(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.Primitives.Selector.GetIsSelectionActive(@element);
        public static System.Boolean GetIsSelected(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.Primitives.Selector.GetIsSelected(@element);
        public static void SetIsSelected(System.Windows.DependencyObject element, System.Boolean isSelected) => Windows.UI.Xaml.Controls.Primitives.Selector.SetIsSelected(@element, @isSelected);
