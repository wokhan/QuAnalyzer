namespace System.Windows.Controls
{
    ...
    public class Canvas : Proxy<global::Windows.UI.Xaml.Controls.Canvas>
    {
        ...
        public static System.Double GetLeft(System.Windows.UIElement element) => Windows.UI.Xaml.Controls.Canvas.GetLeft(@element);
        public static void SetLeft(System.Windows.UIElement element, System.Double length) => Windows.UI.Xaml.Controls.Canvas.SetLeft(@element, @length);
        public static System.Double GetTop(System.Windows.UIElement element) => Windows.UI.Xaml.Controls.Canvas.GetTop(@element);
        public static void SetTop(System.Windows.UIElement element, System.Double length) => Windows.UI.Xaml.Controls.Canvas.SetTop(@element, @length);
        public static System.Double GetRight(System.Windows.UIElement element) => Windows.UI.Xaml.Controls.Canvas.GetRight(@element);
        public static void SetRight(System.Windows.UIElement element, System.Double length) => Windows.UI.Xaml.Controls.Canvas.SetRight(@element, @length);
        public static System.Double GetBottom(System.Windows.UIElement element) => Windows.UI.Xaml.Controls.Canvas.GetBottom(@element);
        public static void SetBottom(System.Windows.UIElement element, System.Double length) => Windows.UI.Xaml.Controls.Canvas.SetBottom(@element, @length);
