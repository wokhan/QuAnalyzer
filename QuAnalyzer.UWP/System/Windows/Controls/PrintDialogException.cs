namespace System.Windows.Controls
{
    ...
    public class PrintDialogException : Proxy<global::Windows.UI.Xaml.Controls.PrintDialogException>
    {
        ...
        public PrintDialogException(): base()
        {
        }

        public PrintDialogException(System.String @message): base(@message)
        {
        }

        public PrintDialogException(System.String @message, System.Exception @innerException): base(@message, @innerException)
        {
        }
