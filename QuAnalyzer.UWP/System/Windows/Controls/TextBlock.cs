namespace System.Windows.Controls
{
    ...
    public class TextBlock : Proxy<global::Windows.UI.Xaml.Controls.TextBlock>
    {
        ...
        public System.Double BaselineOffset
        {
            get => __ProxyValue.BaselineOffset;
            set => __ProxyValue.BaselineOffset = value;
        }
        ...
        public System.Windows.Media.TextEffectCollection TextEffects
        {
            ...
            set => __ProxyValue.TextEffects = value;
        }
        ...
        {
            get => __ProxyValue.LineStackingStrategy;
            set => __ProxyValue.LineStackingStrategy = value;
        }
        ...
        {
            get => __ProxyValue.TextTrimming;
            set => __ProxyValue.TextTrimming = value;
        }
        ...
        public System.Boolean IsHyphenationEnabled
        {
            get => __ProxyValue.IsHyphenationEnabled;
            set => __ProxyValue.IsHyphenationEnabled = value;
        }
        ...
        public TextBlock(System.Windows.Documents.Inline @inline): base(@inline)
        {
        }

        public System.Boolean ShouldSerializeText() => __ProxyValue.ShouldSerializeText();
        public System.Boolean ShouldSerializeInlines(System.Windows.Markup.XamlDesignerSerializationManager manager) => __ProxyValue.ShouldSerializeInlines(@manager);
        public System.Boolean ShouldSerializeBaselineOffset() => __ProxyValue.ShouldSerializeBaselineOffset();
        public System.Windows.Documents.TextPointer GetPositionFromPoint(System.Windows.Point point, System.Boolean snapToText) => __ProxyValue.GetPositionFromPoint(@point, @snapToText);
        public static void SetBaselineOffset(System.Windows.DependencyObject element, System.Double value) => Windows.UI.Xaml.Controls.TextBlock.SetBaselineOffset(@element, @value);
        public static System.Double GetBaselineOffset(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.TextBlock.GetBaselineOffset(@element);
        public static void SetFontFamily(System.Windows.DependencyObject element, System.Windows.Media.FontFamily value) => Windows.UI.Xaml.Controls.TextBlock.SetFontFamily(@element, @value);
        public static System.Windows.Media.FontFamily GetFontFamily(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.TextBlock.GetFontFamily(@element);
        public static void SetFontStyle(System.Windows.DependencyObject element, System.Windows.FontStyle value) => Windows.UI.Xaml.Controls.TextBlock.SetFontStyle(@element, @value);
        public static System.Windows.FontStyle GetFontStyle(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.TextBlock.GetFontStyle(@element);
        public static void SetFontWeight(System.Windows.DependencyObject element, System.Windows.FontWeight value) => Windows.UI.Xaml.Controls.TextBlock.SetFontWeight(@element, @value);
        public static System.Windows.FontWeight GetFontWeight(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.TextBlock.GetFontWeight(@element);
        public static void SetFontStretch(System.Windows.DependencyObject element, System.Windows.FontStretch value) => Windows.UI.Xaml.Controls.TextBlock.SetFontStretch(@element, @value);
        public static System.Windows.FontStretch GetFontStretch(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.TextBlock.GetFontStretch(@element);
        public static void SetFontSize(System.Windows.DependencyObject element, System.Double value) => Windows.UI.Xaml.Controls.TextBlock.SetFontSize(@element, @value);
        public static System.Double GetFontSize(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.TextBlock.GetFontSize(@element);
        public static void SetForeground(System.Windows.DependencyObject element, System.Windows.Media.Brush value) => Windows.UI.Xaml.Controls.TextBlock.SetForeground(@element, @value);
        public static System.Windows.Media.Brush GetForeground(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.TextBlock.GetForeground(@element);
        public static void SetLineHeight(System.Windows.DependencyObject element, System.Double value) => Windows.UI.Xaml.Controls.TextBlock.SetLineHeight(@element, @value);
        public static System.Double GetLineHeight(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.TextBlock.GetLineHeight(@element);
        public static void SetLineStackingStrategy(System.Windows.DependencyObject element, System.Windows.LineStackingStrategy value) => Windows.UI.Xaml.Controls.TextBlock.SetLineStackingStrategy(@element, @value);
        public static System.Windows.LineStackingStrategy GetLineStackingStrategy(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.TextBlock.GetLineStackingStrategy(@element);
        public static void SetTextAlignment(System.Windows.DependencyObject element, System.Windows.TextAlignment value) => Windows.UI.Xaml.Controls.TextBlock.SetTextAlignment(@element, @value);
        public static System.Windows.TextAlignment GetTextAlignment(System.Windows.DependencyObject element) => Windows.UI.Xaml.Controls.TextBlock.GetTextAlignment(@element);
