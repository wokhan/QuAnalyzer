namespace System.Windows.Shapes
{
    ...
    public class Rectangle : Proxy<global::Windows.UI.Xaml.Shapes.Rectangle>
    {
        public System.Double RadiusX
        {
            get => __ProxyValue.RadiusX;
            set => __ProxyValue.RadiusX = value;
        }

        public System.Double RadiusY
        {
            get => __ProxyValue.RadiusY;
            set => __ProxyValue.RadiusY = value;
        }

        public System.Windows.Media.Geometry RenderedGeometry
        {
            get => __ProxyValue.RenderedGeometry;
        }

        public System.Windows.Media.Transform GeometryTransform
        {
            get => __ProxyValue.GeometryTransform;
        }
        ...
        {
            get => __ProxyValue.Fill;
            set => __ProxyValue.Fill = value;
        }

        public System.Windows.Media.Brush Stroke
        {
            get => __ProxyValue.Stroke;
            set => __ProxyValue.Stroke = value;
        }

        public System.Double StrokeThickness
        {
            get => __ProxyValue.StrokeThickness;
            set => __ProxyValue.StrokeThickness = value;
        }

        public System.Windows.Media.PenLineCap StrokeStartLineCap
        {
            get => __ProxyValue.StrokeStartLineCap;
            set => __ProxyValue.StrokeStartLineCap = value;
        }

        public System.Windows.Media.PenLineCap StrokeEndLineCap
        {
            get => __ProxyValue.StrokeEndLineCap;
            set => __ProxyValue.StrokeEndLineCap = value;
        }

        public System.Windows.Media.PenLineCap StrokeDashCap
        {
            get => __ProxyValue.StrokeDashCap;
            set => __ProxyValue.StrokeDashCap = value;
        }

        public System.Windows.Media.PenLineJoin StrokeLineJoin
        {
            get => __ProxyValue.StrokeLineJoin;
            set => __ProxyValue.StrokeLineJoin = value;
        }

        public System.Double StrokeMiterLimit
        {
            get => __ProxyValue.StrokeMiterLimit;
            set => __ProxyValue.StrokeMiterLimit = value;
        }

        public System.Double StrokeDashOffset
        {
            get => __ProxyValue.StrokeDashOffset;
            set => __ProxyValue.StrokeDashOffset = value;
        }

        public System.Windows.Media.DoubleCollection StrokeDashArray
        {
            get => __ProxyValue.StrokeDashArray;
            set => __ProxyValue.StrokeDashArray = value;
        }
