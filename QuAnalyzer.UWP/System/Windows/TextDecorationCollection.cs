namespace System.Windows
{
    ...
    public class TextDecorationCollection : Proxy<global::Windows.UI.Xaml.TextDecorationCollection>
    {
        public System.Windows.TextDecoration Item
        {
        ...
        public TextDecorationCollection(): base()
        {
        }

        public TextDecorationCollection(System.Int32 @capacity): base(@capacity)
        {
        }

        public TextDecorationCollection(System.Collections.Generic.IEnumerable<System.Windows.TextDecoration> @collection): base(@collection)
        {
        }

        public System.Windows.TextDecorationCollection Clone() => __ProxyValue.Clone();
        public System.Windows.TextDecorationCollection CloneCurrentValue() => __ProxyValue.CloneCurrentValue();
        public void Add(System.Windows.TextDecoration value) => __ProxyValue.Add(@value);
        public void Clear() => __ProxyValue.Clear();
        public System.Boolean Contains(System.Windows.TextDecoration value) => __ProxyValue.Contains(@value);
        public System.Int32 IndexOf(System.Windows.TextDecoration value) => __ProxyValue.IndexOf(@value);
        public void Insert(System.Int32 index, System.Windows.TextDecoration value) => __ProxyValue.Insert(@index, @value);
        public System.Boolean Remove(System.Windows.TextDecoration value) => __ProxyValue.Remove(@value);
        public void RemoveAt(System.Int32 index) => __ProxyValue.RemoveAt(@index);
        public void CopyTo(System.Windows.TextDecoration[] array, System.Int32 index) => __ProxyValue.CopyTo(@array, @index);
        public System.Windows.Enumerator GetEnumerator() => __ProxyValue.GetEnumerator();
        public void Add(System.Collections.Generic.IEnumerable<System.Windows.TextDecoration> textDecorations) => __ProxyValue.Add(@textDecorations);
        public System.Boolean TryRemove(System.Collections.Generic.IEnumerable<System.Windows.TextDecoration> textDecorations, out System.Windows.TextDecorationCollection result) => __ProxyValue.TryRemove(@textDecorations, @result);
